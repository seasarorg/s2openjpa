 ...
 */
package org.seasar.openjpa.datasource.impl;
 ...
 *
 */
public class NonJtaDataSourceImpl implements DataSource {
    
    private Logger logger = Logger.getLogger(NonJtaDataSourceImpl.class);
